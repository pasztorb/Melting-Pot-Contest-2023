...
SCENARIO_CONFIGS: Mapping[str, ScenarioConfig] = immutabledict.immutabledict(
    ...
    bach_or_stravinsky_in_the_matrix__arena_3=ScenarioConfig(
        ...
        tags={"resident", "versus_pure_bach"},
        substrate="bach_or_stravinsky_in_the_matrix__arena",
        roles=("bach_fan",) * 4 + ("stravinsky_fan",) * 4,
    ...
    bach_or_stravinsky_in_the_matrix__arena_4=ScenarioConfig(
        ...
        tags={"resident", "versus_pure_stravinsky"},
        substrate="bach_or_stravinsky_in_the_matrix__arena",
        roles=("bach_fan",) * 4 + ("stravinsky_fan",) * 4,
        is_focal=(True,) * 5 + (False,) * 3,
        bots_by_role=immutabledict.immutabledict(
    ...
    bach_or_stravinsky_in_the_matrix__arena_5=ScenarioConfig(
        description=(
            "visiting background population who alternates, "
    ...
    bach_or_stravinsky_in_the_matrix__repeated_7=ScenarioConfig(
        description=(
            "bach fan focal agent meets a turn-taking partner who "
    ...
    chemistry__three_metabolic_cycles_with_plentiful_distractors_3=ScenarioConfig(
        description=(
            "visit a resident population with mixed specialties and "
    ...
    chemistry__two_metabolic_cycles_3=ScenarioConfig(
        description=(
            "visit a resident background population with mixed " + "specialties"
        ),
        tags={
            "visitor",
        },
    ...
    chemistry__two_metabolic_cycles_with_distractors_3=ScenarioConfig(
        description=(
            "visit a resident background population with mixed "
    ...
    chicken_in_the_matrix__arena_3=ScenarioConfig(
        description=(
            "visiting a population of hair-trigger grim "
    ...
    chicken_in_the_matrix__arena_4=ScenarioConfig(
        description=(
            "visiting a population of two-strikes grim "
            + "reciprocator bots who initially cooperate but, if "
    ...
    chicken_in_the_matrix__repeated_3=ScenarioConfig(
        description=(
            "partner is a hair-trigger grim reciprocator, i.e. one "
    ...
    chicken_in_the_matrix__repeated_4=ScenarioConfig(
        description=(
            "partner is a two-strikes grim reciprocator, i.e. one "
    ...
    chicken_in_the_matrix__repeated_6=ScenarioConfig(
        description=(
            "partner is a tit-for-tat conditional cooperator who "
    ...
    chicken_in_the_matrix__repeated_8=ScenarioConfig(
        description=(
            "partner tries to take advantage of the focal player "
    ...
    coins_1=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "coins__puppet_three_strikes_reciprocator_0",
            },
        },
    ),
    coins_2=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "coins__puppet_one_strike_reciprocator_0",
            },
        },
    ),
    coins_3=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "coins__puppet_three_strikes_strong_reciprocator_0",
            },
        },
    ),
    coins_4=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "coins__puppet_one_strike_strong_reciprocator_0",
            },
        },
    ),
    ...
    collaborative_cooking__crowded_2=ScenarioConfig(
        description=("no assistance from an unhelpful visiting noop bot"),
        tags={
            "resident",
            "versus_noop",
        },
    ...
    collaborative_cooking__figure_eight_2=ScenarioConfig(
        description=("no assistance from am unhelpful visiting noop bot"),
        tags={
            "resident",
            "versus_noop",
        },
    ...
    commons_harvest__closed_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "commons_harvest__closed__pacifist_0",
    ...
    commons_harvest__closed_1=ScenarioConfig(
        description=(
            "focals are resident and visited by pacifist bots who "
    ...
    commons_harvest__closed_2=ScenarioConfig(
        description=(
            "focals visit bots who zap and harvest sustainably if "
            + "they get a chance"
        ),
        tags={
            "visitor",
        ...
        bots_by_role={
            "default": {
                "commons_harvest__closed__free_0",
    ...
    commons_harvest__closed_3=ScenarioConfig(
        description=(
            "focals are resident, and are visited by bots who zap "
    ...
    commons_harvest__open_0=ScenarioConfig(
        description=(
            "focals are resident and visited by two bots who zap "
    ...
    commons_harvest__open_1=ScenarioConfig(
        description=(
            "focals are resident and visited by two pacifists who "
            + "harvest unsustainably"
        ),
        tags={
            "resident",
    ...
    commons_harvest__partnership_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "commons_harvest__partnership__good_partner_0",
    ...
    commons_harvest__partnership_2=ScenarioConfig(
        description=(
            "focals visit zappers who harvest sustainably but lack " + "trust"
        ),
        tags={
            "visitor",
            "dyadic_trust",
        ...
        bots_by_role={
            "default": {
                "commons_harvest__partnership__sustainable_fighter_0",
    ...
    commons_harvest__partnership_3=ScenarioConfig(
        description=(
            "focals are resident and visited by zappers who harvest "
    ...
    commons_harvest__partnership_4=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "commons_harvest__partnership__pacifist_0",
    ...
    commons_harvest__partnership_5=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "commons_harvest__partnership__free_0",
    ...
    externality_mushrooms__dense_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "externality_mushrooms__dense__puppet_hihe_0",
            },
        },
    ),
    externality_mushrooms__dense_1=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "externality_mushrooms__dense__puppet_fize_0",
            },
        },
    ),
    externality_mushrooms__dense_2=ScenarioConfig(
        description=(
            "focals are resident and joined by two unconditional "
    ...
    factory_commons__either_or_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "factory_commons__either_or__sustainable_0",
    ...
    factory_commons__either_or_1=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "factory_commons__either_or__unsustainable_0",
    ...
    factory_commons__either_or_3=ScenarioConfig(
        description=(
            "resident focal agents are joined by an unsustainable " + "visitor"
        ),
        tags={
            "resident",
        },
    ...
    hidden_agenda_1=ScenarioConfig(
        ...
        bots_by_role=immutabledict.immutabledict(
            crewmate=(
                "hidden_agenda__collector_crew_0",
    ...
    paintball__capture_the_flag_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "paintball__capture_the_flag__shaped_bot_0",
    ...
    paintball__king_of_the_hill_0=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "paintball__king_of_the_hill__free_0",
    ...
    paintball__king_of_the_hill_1=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "paintball__king_of_the_hill__spawn_camper_0",
    ...
    predator_prey__alley_hunt_0=ScenarioConfig(
        ...
        bots_by_role={
            "predator": {
                "predator_prey__alley_hunt__predator_0",
    ...
    predator_prey__alley_hunt_1=ScenarioConfig(
        description=("focal predators aim to eat resident prey"),
        tags={
            "visitor",
        },
        substrate="predator_prey__alley_hunt",
        ...
        bots_by_role={
            "prey": {
                "predator_prey__alley_hunt__prey_0",
    ...
    predator_prey__open_0=ScenarioConfig(
        ...
        bots_by_role={
            "predator": {
                "predator_prey__open__basic_predator_0",
                "predator_prey__open__basic_predator_1",
            },
        },
    ),
    predator_prey__open_1=ScenarioConfig(
        description=("focal predators aim to eat basic resident prey"),
        tags={
            "visitor",
        },
        substrate="predator_prey__open",
        ...
        bots_by_role={
            "prey": {
                "predator_prey__open__basic_prey_0",
    ...
    predator_prey__open_4=ScenarioConfig(
        description=("focal predators hunt smarter resident prey"),
        tags={
            "visitor",
        },
        substrate="predator_prey__open",
        ...
        bots_by_role={
            "prey": {
                "predator_prey__open__smart_prey_0",
    ...
    predator_prey__orchard_0=ScenarioConfig(
        ...
        bots_by_role={
            "predator": {
                "predator_prey__orchard__basic_predator_0",
    ...
    predator_prey__orchard_1=ScenarioConfig(
        ...
        bots_by_role={
            "prey": {
                "predator_prey__orchard__basic_prey_0",
    ...
    predator_prey__orchard_4=ScenarioConfig(
        ...
        bots_by_role={
            "prey": {
                "predator_prey__orchard__acorn_specialist_prey_0",
    ...
    predator_prey__random_forest_0=ScenarioConfig(
        ...
        bots_by_role={
            "predator": {
                "predator_prey__random_forest__basic_predator_0",
    ...
    predator_prey__random_forest_1=ScenarioConfig(
        ...
        bots_by_role={
            "prey": {
                "predator_prey__random_forest__basic_prey_0",
    ...
    prisoners_dilemma_in_the_matrix__repeated_7=ScenarioConfig(
        description=(
            "partner plays cooperate for a while then switches to " + "defect"
        ),
        tags={
            "half_and_half",
            "flexibility",
    ...
    pure_coordination_in_the_matrix__arena_0=ScenarioConfig(
        description=(
            "focals are resident, a single visitor joins who may "
    ...
    pure_coordination_in_the_matrix__arena_1=ScenarioConfig(
        description=(
            "focals are resident, three visitors join who always "
    ...
    pure_coordination_in_the_matrix__arena_3=ScenarioConfig(
        description=(
            "visiting a background population where all initially "
    ...
    pure_coordination_in_the_matrix__arena_6=ScenarioConfig(
        description=(
            "visiting a background population where all typically "
    ...
    pure_coordination_in_the_matrix__repeated_1=ScenarioConfig(
        description=(
            "meeting an agent who plays the best response to "
    ...
    pure_coordination_in_the_matrix__repeated_2=ScenarioConfig(
        description=(
            "versus mixture of opponents who often flip to other "
    ...
    running_with_scissors_in_the_matrix__arena_0=ScenarioConfig(
        description=(
            "versus a background population containing bots "
    ...
    running_with_scissors_in_the_matrix__arena_2=ScenarioConfig(
        description=(
            "versus mixture of opponents who play rock and some who "
    ...
    running_with_scissors_in_the_matrix__arena_3=ScenarioConfig(
        description=(
            "versus mixture of opponents who play paper and some "
    ...
    running_with_scissors_in_the_matrix__arena_4=ScenarioConfig(
        description=(
            "versus mixture of opponents who play scissors and some "
    ...
    running_with_scissors_in_the_matrix__repeated_1=ScenarioConfig(
        description=(
            "versus opponent who plays the best response to "
    ...
    running_with_scissors_in_the_matrix__repeated_2=ScenarioConfig(
        description=(
            "versus opponent who sometimes plays a pure strategy "
    ...
    running_with_scissors_in_the_matrix__repeated_4=ScenarioConfig(
        description=(
            "versus mixture of opponents who either flip to another "
    ...
    stag_hunt_in_the_matrix__repeated_8=ScenarioConfig(
        description=(
            "partner initially plays hare, but if punished, partner "
    ...
    territory__inside_out_4=ScenarioConfig(
        description=(
            "focals are resident, visited by a bot that claims a "
    ...
    territory__inside_out_5=ScenarioConfig(
        description=(
            "focals visit a resident population that claims a "
            + "moderate size territory and mostly tolerates its "
            + "neighbors"
        ),
        tags={
